...
export class OnePostComponent implements OnInit, AfterViewChecked, OnDestroy {
  ...
  */
  ...
  ngOnInit() {
   ...
   // this.fetchAllPosts();
    ...
    this.businessService.getBusinessIdByPostID(this.postId).subscribe(res => {
      if(res){
